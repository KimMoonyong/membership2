...
pluralCaseList.push( {plural: "points/points", pascal: "PointPoint"} )

pluralCaseList.push( {plural: "agreements/agreements", pascal: "AgreementAgreement"} )

pluralCaseList.push( {plural: "benefits/benefits", pascal: "BenefitsBenefits"} )
